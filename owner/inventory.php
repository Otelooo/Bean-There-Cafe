...
<div class="modal-overlay" id="modal-add-item">
  <div class="modal-box">
    ...
    <form method="POST" action="inventory.php" onsubmit="return checkAddForm(event, this)">
...
<div class="modal-overlay" id="modal-edit-item">
  <div class="modal-box">
    ...
    <form method="POST" action="inventory.php" onsubmit="return checkEditForm(event, this)">
...
<div id="print-report">
  <div class="pr-head">
    <div>
      <div class="pr-title">Bean There Caf&eacute; &#8212; Inventory Report</div>
      <div class="pr-sub">Raw Ingredients &#38; Supplies &#8212; Full Stock Details</div>
    </div>
    <div class="pr-meta">
      <div>Date Printed: <span id="pr-date"></span></div>
      <div>Printed by: <?= htmlspecialchars($displayName) ?> (Cafe Owner)</div>
