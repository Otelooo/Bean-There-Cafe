...
$stmt = $conn->prepare("SELECT COALESCE(SUM(transaction_total),0) AS total FROM transactions WHERE transaction_status = 'completed' AND DATE(transaction_date) = CURDATE() AND user_id = ?");
